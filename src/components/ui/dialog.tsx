...
function DialogOverlay({
  ...
  return (
    <ModalOverlayPrimitive
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-black/30 duration-300 data-entering:animate-in data-entering:fade-in-0 data-exiting:animate-out data-exiting:fade-out-0 supports-backdrop-filter:backdrop-blur-sm",
        className,
      )}
      {...props}
    >
